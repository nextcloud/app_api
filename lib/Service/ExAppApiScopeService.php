...
class ExAppApiScopeService {
	...
	public function __construct(
		...
		$this->apiScopes = [
			// AppAPI scopes
			['api_route' => $aeApiV1Prefix . '/ui/files-actions-menu', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV2Prefix . '/ui/files-actions-menu', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV1Prefix . '/ui/top-menu', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV1Prefix . '/ui/initial-state', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV1Prefix . '/ui/script', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV1Prefix . '/ui/style', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => $aeApiV1Prefix . '/ui/settings', 'scope_group' => 1, 'name' => 'BASIC'],
			...
			['api_route' => $aeApiV1Prefix . '/routes', 'scope_group' => 1, 'name' => 'BASIC'],
			...
			['api_route' => $aeApiV1Prefix . '/talk_bot', 'scope_group' => 60, 'name' => 'TALK_BOT'],
			['api_route' => $aeApiV1Prefix . '/ai_provider/', 'scope_group' => 61, 'name' => 'AI_PROVIDERS'],
			['api_route' => $aeApiV1Prefix . '/events_listener', 'scope_group' => 62, 'name' => 'EVENTS_LISTENER'],
			['api_route' => $aeApiV1Prefix . '/occ_command', 'scope_group' => 63, 'name' => 'OCC_COMMAND'],

			// AppAPI internal scopes
			['api_route' => '/apps/app_api/apps/status', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => '/apps/app_api/ex-app/status', 'scope_group' => 1, 'name' => 'BASIC'],
			['api_route' => '/apps/app_api/ex-app/state', 'scope_group' => 1, 'name' => 'BASIC'],
			...
			['api_route' => '/settings/admin/log/', 'scope_group' => 2, 'name' => 'SYSTEM'],
			...
			['api_route' => '/cloud/user', 'scope_group' => 30, 'name' => 'USER_INFO'],
			...
			['api_route' => '/taskprocessing/', 'scope_group' => 61, 'name' => 'AI_PROVIDERS'],
			['api_route' => '/apps/activity/api/', 'scope_group' => 110, 'name' => 'ACTIVITIES'],
			['api_route' => '/apps/notes/api/', 'scope_group' => 120, 'name' => 'NOTES'],
			['api_route' => '/textprocessing/', 'scope_group' => 200, 'name' => 'TEXT_PROCESSING'],
			['api_route' => '/translation/', 'scope_group' => 210, 'name' => 'MACHINE_TRANSLATION'],

			//ALL Scope
			['api_route' => 'non-exist-all-api-route', 'scope_group' => self::ALL_API_SCOPE, 'name' => 'ALL'],
		];
	}
