...
if __name__ == "__main__":
    ...
    assert nc_client.apps.is_disabled("nc_py_api") is False
    ...
    assert nc_client.apps.is_disabled("nc_py_api") is True
    notifications = nc_client.users.notifications.get_all()
    notification = [i for i in notifications if i.info.subject == "ex_app_version_update"]
