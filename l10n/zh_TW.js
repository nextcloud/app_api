OC.L10N.register(
    ...
    "ExApps" : "外部應用程式",
    "ExApps management similar to default apps and available by the link below or ." : "外部應用程式管理類似於預設應用程式，可透過以下連結使用。",
    ...
    "\"manual-install\" Deploy Daemon can not be set as default" : "「手動安裝」部署幕後程式無法設定為預設值",
    ...
    "Enable gpus support (attach gpu to ExApp containers))" : "啟用 GPU 支援（附加 GPU 到外部應用程式容器）",
