OC.L10N.register(
    ...
    "ExApps" : "外部應用程式",
    "ExApps management similar to default apps and available by the link below." : "外部應用程式管理類似於預設應用程式，可透過以下連結使用。",
    ...
    "This action will not remove installed ExApps on this daemon" : "此動作不會移除此幕後程式上已安裝的外部應用程式",
    ...
    "SSL params" : "SSL 參數",
    "SSL key:" : "SSL 金鑰：",
    "SSL key pass:" : "SSL 金鑰密碼：",
    "SSL cert:" : "SSL 憑證：",
    "SSL cert pass:" : "SSL 憑證密碼：",
    "GPUs support:" : "GPU 支援：",
    ...
    "Register default DaemonConfig" : "註冊預設 DaemonConfig",
    ...
    "Host" : "主機",
    "Hostname to reach ExApp (optional)" : "到達外部應用程式的主機名稱（選擇性）",
    "Enable gpus support (attach gpu to ExApp containers)" : "啟用 GPU 支援（附加 GPU 到外部程式容器）",
    "Enable GPUs support" : "啟用 GPU 支援",
    "All GPU devices will be requested to be enabled in ExApp containers" : "所有 GPU 裝置都將被要求在外部應用程式容器啟用",
    "Register" : "註冊",
