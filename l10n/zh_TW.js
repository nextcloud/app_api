OC.L10N.register(
    ...
    "Host name to access ExApps" : "用來存取外部應用程式的主機名稱",
    "Host name or path to access Docker daemon (e.g. aa-docker-socket-proxy:2375, /var/run/docker.sock)" : "存取 Docker 幕後程式的主機名稱或路徑（例如 aa-docker-socket-proxy:2375、/var/run/docker.sock）",
