OC.L10N.register(
    ...
    "Failed to register ExApp" : "註冊外部應用程式失敗",
    "Failed to deploy ExApp" : "部署外部應用程式失敗",
    "Failed to send \"init\" event to ExApp." : "無法傳送「init」事件至外部應用程式。",
    "Failed to enable ExApp" : "啟用外部應用程式失敗",
    "Failed to disable ExApp" : "停用外部應用程式失敗",
    "Could not update ExApp" : "無法更新外部應用程式",
    "ExApp not found, failed to get status" : "找不到外部應用程式，無法取得狀態",
    "AppAPI authentication failed" : "AppAPI 驗證失敗",
    "AppAPI ExApp version update notifier" : "AppAPI 外部應用程式版本更新通知",
    "AppAPI ExApp notifier" : "AppAPI 外部應用程式通知",
    "AppAPI" : "AppAPI",
    "AI Integration Team" : "整合團隊",
    "ExApps Settings" : "外部應用程式設定",
    ...
    "Deploy Daemon (DaemonConfig) is an ExApps orchestration daemon." : "部署幕後程式 (DaemonConfig) 是外部應用程式的協作幕後程式。",
    ...
    "All ExApps are up-to-date." : "所有外部程式均已最新。",
    ...
    "Default daemon. ExApps will be installed on it" : "預設幕後程式。外部應用程式將會安裝在其上",
