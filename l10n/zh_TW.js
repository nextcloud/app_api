OC.L10N.register(
    ...
    "Error starting install of ExApp" : "開始安裝外部應用程式時發生錯誤",
    "Could not perform installation of ExApp" : "無法執行外部應用程式的安裝",
    "Failed to enable ExApp" : "啟用外部應用程式失敗",
    "Failed to disable ExApp" : "停用外部應用程式失敗",
    "Could not update ExApp" : "無法更新外部應用程式",
    "Error starting update of ExApp" : "開始更新外部應用程式時發生錯誤",
    "Could not perform update of ExApp" : "無法執行外部應用程式的更新",
