OC.L10N.register(
    ...
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "這些是一般 DaemonConfig 的預設設定。您可以根據需求變更它們；更多資訊請參閱文件。",
