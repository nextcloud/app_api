OC.L10N.register(
    ...
    {
    "External Apps" : "外部程序",
    "Only docker-install is supported for now" : "仅支持 Docker 安装",
    "Failed to register ExApp" : "无法注册外部程序",
    "Failed to Deploy ExApp" : "无法卸载外部程序",
    "Failed to send \"init\" event to ExApp." : "无法发送“初始化”事件至外部程序",
