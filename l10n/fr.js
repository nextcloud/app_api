OC.L10N.register(
    ...
    "SSL params" : "Paramètres SSL",
    "SSL key:" : "Clé SSL :",
    "SSL key pass:" : "Phrase de passe SSL :",
    "SSL cert:" : "Certificat SSL :",
    "SSL cert pass:" : "Passe du certificat SSL :",
    "GPUs support:" : "Prise en charge GPU :",
    "Verify connection" : "Vérifier la connexion",
    "Daemon connection successful" : "Connexion au Deamon réussie",
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "Ce sont les paramètres par défaut pour une DeamonConfig normale. Vous pouvez les changer comme vous le souhaitez ; plus d'informations sur ceux-ci sont disponibles sur la documentation.",
    "Display name" : "Nom d'affichage",
    "Protocol" : "Protocole",
    "Select protocol" : "Sélectionner le protocole",
    ...
    "Host" : "Hôte",
    "Register" : "S'inscrire",
    "Unix socket path (e.g. /var/run/docker.sock)" : "Chemin vers le socket Unix (par ex. /var/run/docker.sock)",
    "Host with port (e.g. proxy-domain.com:2375)" : "Hôte avec port (par ex. proxy-domaine.com:2375)",
