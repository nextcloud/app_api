OC.L10N.register(
    ...
    "Could not retrieve HaRP version from daemon \"%s\"" : "Nezdařilo se získat HaRP verzi od démona \"%s\"",
    "HaRP version for daemon \"%s\" is \"%s\", which is too old. The minimum required version is \"%s\". Please update the daemon to the latest version." : "HaRP verze pro démona \"%s\" je \"%s\", která je příliš zastaralá. Minimální vyžadovaná verze je \"%s\". Aktualizujte démona na novější verzi.",
    "Failed to check HaRP version for daemon \"%s\": %s" : "Selhalo ověření HaRP verze pro démona \"%s\": %s",
    ...
    "FRP is always disabled for the All-in-One setup." : "FRP je vždy vypnuto pro All-in-One setup.",
