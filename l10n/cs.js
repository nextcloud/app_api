OC.L10N.register(
    ...
    "Currently only Docker Daemon is supported." : "V tuto chvíli je podporován pouze proces služby Docker.",
    ...
    "SSL params" : "Parametry SSL",
    "SSL key:" : "SSL klíč:",
    "SSL key pass:" : "Heslo k SSL klíči:",
    "SSL cert:" : "SSL certifikát:",
    "SSL cert pass:" : "Heslo k SSL certifikátu:",
    "GPUs support:" : "Podpora pro výpočty na GPU:",
    "Verify connection" : "Ověřit připojení",
    "Display name" : "Zobrazované jméno",
    "Protocol" : "Protokol",
    "Select protocol" : "Vybrat protokol",
    "Nextcloud URL" : "URL adresa Nextcloud",
    ...
    "Unix socket path (e.g. /var/run/docker.sock)" : "Popis umístění unixového soketu (např. /var/run/docker.sock)",
    "Host with port (e.g. proxy-domain.com:2375)" : "Hostitel včetně portu (např. domena_s_proxy.com:2375)",
