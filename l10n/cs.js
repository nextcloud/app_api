OC.L10N.register(
    ...
    "The AppAPI default deploy daemon is not using HaRP. Please consider switching to HaRP for better performance." : "Výchozí AppAPI proces služby nasazování nepoužívá HaRP. Zvažte přechod na něj a vylepšete tak výkon.",
    "AppAPI HaRP version check" : "AppAPI HaRP kontrola verze",
    "Could not retrieve HaRP version from daemon \"%s\"" : "Nezdařilo se získat HaRP verzi od procesu služby „%s“",
    "HaRP version for daemon \"%s\" is \"%s\", which is too old. The minimum required version is \"%s\". Please update the daemon to the latest version." : "HaRP verze pro proces služby „%s“ je „%s“, která je příliš zastaralá. Minimální vyžadovaná verze je „%s“. Aktualizujte proces služby na novější verzi.",
    "Failed to check HaRP version for daemon \"%s\": %s" : "Nezdařilo se ověření HaRP verze pro proces služby „%s“: %s",
    ...
    "The AppAPI Project is an exciting initiative that aims to revolutionize the way applications are developed for Nextcloud through the use of docker containers. Allowing for greater programming language choice and allowing computationally expensive tasks to be offloaded to a different server." : "Projekt AppAPI je vzrušující iniciativa, která cílí na zmodernizování vývoje aplikací pro Nextcloud s pomocí docker kontejnerů. To umožňuje širší volbu programovacích jazyků a delegování výpočetně náročnějších úloh na jiný server.",
    "Deploy daemons" : "Nasadit procesy služeb",
    "A deploy daemon (DaemonConfig) is an ExApps orchestration daemon." : "Proces služby nasazování (DaemonConfig) slouží pro orchestraci ExApps.",
    "Deploy daemons. A deploy daemon (DaemonConfig) is an ExApps orchestration daemon." : "Procesy nasazování. Proces služby nasazování (DaemonConfig) slouží pro orchestraci ExApps.",
    "Default deploy daemon is not accessible. Please check its configuration" : "Výchozí proces služby nasazování není dostupný. Zkontrolujte její nastavení",
    ...
    "Choose the container restart policy, e.g. 'always' to ensure ExApps will be running after a daemon server reboot" : "Zvolte zásadu pro restartování kontejneru – například 'always', která zajistí že ExApp aplikace budou spuštěné po restartu serveru s procesem služby",
    "This settings changes are effective only for newly created containers" : "Změny tohoto nastavení se budou týkat pouze nově vytvářených kontejnerů",
    "Deploy daemon deletion confirmation" : "Potvrzení smazání procesu služby nasazování",
    "Are you sure you want delete the \"{name}\" deploy daemon?" : "Opravdu chcete proces nasazování „{name}“ smazat?",
    "Remove all ExApps installed on this daemon" : "Odebrat veškeré ExApps, nainstalované na tomto procesu služby",
    "Cancel" : "Storno",
    "Delete" : "Smazat",
    "A \"manual-install\" deploy daemon cannot be set as default" : "Proces služby „manual-install“ nemůže být nastaven jako výchozí",
    "Failed to save admin settings. Check the logs" : "Nepodařilo se uložit nastavení pro správu. Nahlédněte do záznamů událostí",
    ...
    "Failed to connect to the daemon. Check the logs" : "Nepodařilo se spojit s procesem služby. Nahlédněte do záznamu událostí",
    "Failed to check connection to the daemon. Check the logs" : "Nepodařilo se zkontrolovat spojení s procesem služby. Nahlédněte do záznamu událostí",
    "Unlimited" : "Neomezeně",
    "{size} GiB" : "{size} GiB",
    "{size} MiB" : "{size} MiB",
    "_{n} CPU_::_{n} CPUs_" : ["{n} procesor","{n} procesory","{n} procesorů","{n} procesory"],
    "Deploy daemon configuration" : "Nastavení procesu služby nasazování",
    "Deploy daemon configuration details" : "Podrobnosti nastavení procesu služby nasazování",
    "Deploy daemon" : "Proces nasazování",
    "Default daemon. ExApps will be installed on it" : "Výchozí proces služby. ExApps budou instalovány na něj",
    "The \"Manual install\" daemon is usually used for development. It cannot be set as the default daemon." : "Proces služby „Ruční instalace“ je obvykle používán pro vývoj. Není možné ho nastavit jako výchozí.",
    ...
    "Node port" : "Port uzlu",
    "Upstream host" : "Nadřazený hostitel",
    ...
    "Computation device" : "Výpočetní zařízení",
    ...
    "No Deploy daemons are registered" : "Nejsou zaregistrované žádné procesy služby nasazování",
    "Register a custom one or configure one from the available templates" : "Zaregistrujte uživatelsky určené nebo nastavte z dostupných šablon",
    ...
    "AppAPI will try to install small skeleton ExApp to check that the daemon is configured correctly and the deployment steps are successful." : "AppAPI se pokusí nainstalovat malou maketu ExApp kvůli kontrole, že je proces služby správně nastaven a toho, že jsou kroky nasazování úspěšné.",
    "The following deploy test checks must succeed:" : "Je třeba, aby aby následující kontroly zkoušky nasazení byly úspěšné:",
    "More information" : "Podrobnosti",
    "Download ExApp logs" : "Stáhnout si záznamy událostí v ExApp",
    "Remove the test ExApp" : "Odebrat testovací ExApp",
    "Start the deploy test" : "Spustit zkoušku nasazení",
    "Stop the deploy test" : "Zastavit zkoušku nasazení",
    "The test ExApp is unregistered and its container is removed on \"Stop the deploy test\"" : "Registrace testovací ExApp zrušena a jeho kontejner odebrán na „Zastavit zkoušku nasazení“",
    ...
    "Configure Docker registry override mappings for the selected daemon." : "Nastavit mapování přebití Docker registru pro označený proces služby.",
    "The matching source registry in ExApp info.xml will be overwritten during deployment (image pull step)." : "Odpovídající zdrojový registru v ExApp info.xml bude přebit při nasazování (krok image pull)",
    ...
    "Remove" : "Odebrat",
    "No custom Docker registries are registered" : "Nezaregistrovány žádné uživatelsky určené Docker registry",
    ...
    "Add" : "Přidat",
    "Hostname used by Nextcloud to access the ExApps" : "Název stroje, používaný Nextcloud pro přístup k ExApp aplikacím",
    ...
    "A daemon with this name already exists" : "Takto nazvaný proces služby už existuje",
    ...
    "Changes are only effective for newly installed ExApps. For existing ExApps, the Docker containers should be recreated to apply the new settings values." : "Změny jsou uplatněny pouze pro nově instalované ExApp aplikace. Pro stávající ExApps, aby nové hodnoty nastavení byly uplatněny, by měly Docker kontejnery být znovu vytvořeny.",
    "The Docker network that the deployed ExApps will use." : "Docker síť kterou budou nasazované ExApps aplikace používat.",
    "The URL should start with http:// or https://" : "URL by měly začínat na http:// nebo https://",
    "For a HTTPS daemon, the Nextcloud URL should be HTTPS" : "Pro HTTPS proces služby, URL Nextcloud by měla být HTTPS",
    "All available GPU devices on the daemon host need to be enabled in ExApp containers by Docker." : "Na hostiteli procesů služeb bude třeba, aby veškerá GPU zařízení byla Dockerem zpřístupněna v kontejnerech ExApp aplikací.",
    ...
    "Edit the deploy daemon" : "Upravit proces služby nasazován",
    "Register a new deploy daemon" : "Zaregistrovat nový proces služby nasazování",
    "Daemon configuration template" : "Šablona nastavení procesu služby",
    "Select a daemon configuration template" : "Vyberte šablonu nastavení procesu služby",
    ...
    "Select the daemon deploy method" : "Vyberte metodu nasazování procesu služby",
    "HaRP host" : "Hostitel s HaRP",
    "Daemon host" : "Hostitel procesu služby",
    "HaRP shared key" : "Sdílený klíč HaRP",
    "The password must be at least 12 characters long" : "Je třeba, aby heslo bylo alespoň 12 znaků dlouhé",
    "Set this daemon as the default one" : "Nastavit tento proces služby jako výchozí",
    "Set as the default daemon" : "Nastavit jako výchozí proces služby",
    "Enable HTTPS" : "Zapnout HTTPS",
    "Show deploy options" : "Zobrazit předvolby nasazení",
    "Hide deploy options" : "Skrýt předvolby nasazen",
    "Enable HaRP" : "Zapnout HaRP",
    "FRP server address" : "Adresa FRP serveru",
    "The address (host:port) of the FRP server that should be reachable by the ExApp in the network defined in the 'Docker network' section." : "Adresa (hostitel:port) FRP serveru, který by měl být dosažitelný ExApp v síti, definované v sekci 'Docker Network'.",
    ...
    "FRP is always disabled for the All-in-One setup." : "FRP v případě uspořádání vše v jednom vždy vypnuté.",
    "Flag for advanced setups only. Disables the FRP tunnel between ExApps and HaRP." : "Příznak pouze pro pokročilá uspořádání. Vypíná FRP tunel mezi ExApplikacem a HaRP.",
    ...
    "Maximum amount of memory that the ExApp container can use in mebibytes" : "Kolik operační paměti nejvýše bude moci ExApp kontejner využívat (v MiB)",
    ...
    "Maximum number of CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)" : "Kolik jader procesoru nejvýše bude moci ExApp kontejner využívat (např. 0.5 pro půl jádra, 2 pro dvě jádra)",
