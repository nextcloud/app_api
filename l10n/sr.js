OC.L10N.register(
    ...
    "ExApp not found, failed to get status" : "ExApp није пронађена, није упело добављање статуса",
    ...
    "Delete" : "Избриши",
    "Confirm Deploy daemon deletion" : "Потврда брисања Даемона за постављање",
    "Cancel" : "Откажи",
    "Ok" : "У реду",
    ...
    "Only NVIDIA GPUs are supported for now." : "За сада су подржани само NVIDIA GPU.",
