OC.L10N.register(
    ...
    "Failed to deploy ExApp" : "Није успело постављање ExApp",
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below." : "Управљање ExApps је слично подразумеваним апликацијама и доступно је на линку испод.",
    ...
    "SSL key:" : "SSL кључ: ",
    "SSL key pass:" : "SSL лозинка кључа:",
    "SSL cert:" : "SSL сертификат:",
    "SSL cert pass:" : "SSL лозинка сертификата:",
    "GPUs support:" : "Подршка за GPU:",
    ...
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "Ово су подразумевана подешавања за обичну DaemonConfig. Ако желите, можете да је промените; више о томе се налази у документацији.",
