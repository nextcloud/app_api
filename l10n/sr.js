OC.L10N.register(
    ...
    "Hostname or path to access Docker daemon (e.g. aa-docker-socket-proxy:2375, /var/run/docker.sock)" : "Име хоста или путања за приступ Docker даемону (нпр. aa-docker-socket-proxy:2375, /var/run/docker.sock)",
