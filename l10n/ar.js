OC.L10N.register(
    ...
    "This app is not installed from the AppStore. No extra information available. Only enable/disable and remove actions are allowed." : "لم يتم تثبيت هذا التطبيق من متجر التطبيقات. لا تتوفر معلومات إضافية عنه. يُسمح فقط بإجراءات التمكين/التعطيل والإزالة.",
    ...
    "Error starting update of ExApp" : "حدث خطأ عند البدء في تحديث EXApp",
    ...
    "ExApp init timeout (minutes)" : "مُهلة بدء التطبيقات الخارجية ExApp (بالدقائق)",
    ...
    "ExApps installed" : "البرنامج الخارحي ExApps تمّ تثبيته",
    "Name" : "الاسم",
    "Protocol" : "بروتوكول",
    "Host" : "المضيف",
    ...
    "Check if the image is successfully pulled" : "التحقُّق من أن الصورة قد تمّ سحبها بنجاحٍ",
    "Container started" : "الحاوية بدأت",
    "Check if the image successfully pulled and container is created and started" : "التحقُّق من أن الصورة قد تمّ سحبها بنجاحٍ و أن الحاوية قد أنشئت و بدأت",
    "Heartbeat" : "النبض",
    "Check for the heartbeat is finished and healthy" : "التحقُّق من أن النبض قد اكتمل و بشكل سليم",
    "Init step" : "الخطوة الأوّليّة",
    "Wait for initialization step to finish" : "انتظار الانتهاء من الخطوة الأوّليّة",
    "Enabled" : "مُفعّل",
    "Check if ExApp successfully handled the enabled event and registered all stuff properly" : "التحقُّق مما إذا كان ExApp قد نجح في التعامل مع الحدث المُمكّن و قد تمّ تسجيل كل شيءٍ بالشكل الصحيح",
