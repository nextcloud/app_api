OC.L10N.register(
    ...
    "Hostname or path to access Docker daemon (e.g. aa-docker-socket-proxy:2375, /var/run/docker.sock)" : "اسم المضيف أو مسار الوصول إلى البرنامج الخفي \"دوكر\" Docker. على سبيل المثال: (aa-docker-socket-proxy:2375, /var/run/docker.sock)",
