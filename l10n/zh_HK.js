OC.L10N.register(
    ...
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "這些是一個常規DaemonConfig的默認設定。您可以根據需要更改它們；更多資訊請參閱文件。",
