OC.L10N.register(
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below." : "ExApps 管理類似於默認應用程式，可透過以下連結使用。",
    ...
    "This action will not remove installed ExApps on this daemon" : "此操作不會移除此守護程序上已安裝的 ExApps",
    ...
    "Host" : "主機",
    "Hostname to reach ExApp (optional)" : "即將達到 ExApp 主機 (非強制的)",
