OC.L10N.register(
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below or ." : "ExApps 管理類似於默認應用程式，可透過以下連結使用。",
    ...
    "\"manual-install\" Deploy Daemon can not be set as default" : "「手動安裝」部署幕後程式無法設定為默認值",
