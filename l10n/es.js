OC.L10N.register(
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below." : "La gestión de ExApps es similar a las apps predeterminadas y está disponible en el enlace a continuación.",
    ...
    "Currently only Docker Daemon is supported." : "Actualmente, solo hay soporte para el Daemon Docker.",
    ...
    "Required" : "Requerido",
    "Optional" : "Opcional",
    "All granted scopes" : "Todos lo ámbitos otorgados",
    "No required scopes" : "Sin ámbitos requeridos",
    "No optional scopes" : "No hay ámbitos opcionales",
    ...
    "This action will not remove installed ExApps on this daemon" : "Esta acción no eliminará las ExApps instaladas en este daemon",
    ...
    "Docker network:" : "Red Docker:",
    "Nextcloud URL:" : "URL de Nextcloud:",
    "SSL params" : "Parámetros SSL",
    "SSL key:" : "Llave SSL:",
    "SSL key pass:" : "Contraseña de llave SSL:",
    "SSL cert:" : "Certificado SSL:",
    "SSL cert pass:" : "Contraseña de certificado SSL:",
    "GPUs support:" : "Soporte a GPUs:",
    ...
    "No DaemonConfigs" : "Sin DaemonConfigs",
    "No DaemonConfigs registered. Create a custom one or setup default configuration automatically" : "No hay DaemonConfigs registradas. Cree una personalizada o establezca la configuración predeterminada automáticamente",
    "Register default DaemonConfig" : "Registrar DaemonConfig predeterminada",
    ...
    "Supported daemon accepts-deploy-id:" : "El daemon soportado accepts-deploy-id:",
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "Estos son los ajustes predeterminados para el DaemonConfig regular. Puede cambiarlos como desee; Más información sobre esto en la documentación.",
    "Unique Deploy Daemon Name" : "Nombre único del Daemon de despliegue",
    "Display name" : "Nombre para mostrar",
    "Accepts deploy ID" : "Acepta deploy ID",
    "Select daemon accepts-deploy-id" : "Seleccione accepts-deploy-id del daemon",
    "Protocol" : "Protocolo",
    "Select protocol" : "Seleccione protocolo",
    "Daemon host" : "Host del daemon",
    "Daemon host (e.g. /var/run/docker.sock, proxy-domain.com:2375)" : "Host del Daemon (p. ej. /var/run/docker.sock, proxy-domain.com:2375)",
    "Nextcloud URL" : "URL de Nextcloud",
    ...
    "Host" : "Servidor",
    "Hostname to reach ExApp (optional)" : "Nombre de host para ExApp (opcional)",
    ...
    "All GPU devices will be requested to be enabled in ExApp containers" : "A todos los dispositivos GPU se les solicitará ser habilitados en los contenedores de ExApps",
    "Register" : "Registrarse",
    "Unix socket path (e.g. /var/run/docker.sock)" : "Ruta al socket Unix (p. ej. /var/run/docker.sock)",
    "Host with port (e.g. proxy-domain.com:2375)" : "Host con puerto (p. ej. proxy-domain:2375)",
    "Your apps" : "Tus apps",
