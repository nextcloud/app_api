OC.L10N.register(
    ...
    "Hostname or path to access Docker daemon (e.g. aa-docker-socket-proxy:2375, /var/run/docker.sock)" : "Nombre de host para acceder al daemon Docker (p. ej. aa-docker-socket-proxy:2375, /var/run/docker.sock)",
