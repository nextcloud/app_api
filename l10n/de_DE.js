OC.L10N.register(
    ...
    "Daemon config not found" : "Daemon-Kionfiguration nicht gefunden",
    ...
    "AppAPI will try to install small skeleton ExApp to verify Daemon configured correctly and deployment steps are passing." : "AppAPI wird versuchen, ein kleines ExApp-Skelett zu installieren, um zu überprüfen, ob der Daemon richtig konfiguriert ist und die Bereitstellungsschritte erfolgreich sind.",
    "The following Deploy test checks must be passed to succeed:" : "Die folgenden Deploy-Testprüfungen müssen bestanden werden, um Erfolg zu haben:",
    ...
    "ExApp is unregistered and container is removed on \"Stop deploy test\"" : "ExApp ist nicht registriert und der Container wird bei „Bereitstellungstest beenden“ entfernt.",
    ...
    "Check for the heartbeat is finished and healthy" : "Überprüfen, ob der Herzschlag beendet und gesund ist",
    "Init step" : "Initial-Schritt",
    "Wait for initialization step to finish" : "Warten, bis der Initialisierungsschritt abgeschlossen ist",
    "Enabled" : "Aktiviert",
