OC.L10N.register(
    ...
    "AppAPI default deploy daemon is not using HaRP. Please consider upgrading to it for better performance." : "Níl deamhan imlonnaithe réamhshocraithe AppAPI ag baint úsáide as HaRP. Déan machnamh le do thoil ar uasghrádú a dhéanamh air le haghaidh feidhmíochta níos fearr.",
    ...
    "The docker network that the deployed ex-apps would use." : "An líonra docker a d'úsáidfeadh na sean-aipeanna imlonnaithe.",
    ...
    "Maximum memory that the ExApp container can use in mebibytes" : "Uasmhéid cuimhne is féidir leis an gcoimeádán ExApp a úsáid i meibibheart",
    "Must be a positive integer" : "Ní mór gur slánuimhir dhearfach í",
    "Maximum CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)" : "Uasmhéid croíleacán LAP is féidir leis an gcoimeádán ExApp a úsáid (m.sh. 0.5 le haghaidh leathchroí, 2 le haghaidh dhá chroí)",
