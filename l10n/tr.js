OC.L10N.register(
    ...
    "Maximum memory that the ExApp container can use in mebibytes" : "ExApp kapsayıcısının mebibayt cinsinden kullanabileceği en fazla bellek",
    "Must be a positive integer" : "Bir pozitif tam sayı olmalıdır",
    "Maximum CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)" : "ExApp kapsayıcısının kullanabileceği en fazla işlemci çekirdeği (yarım çekirdek için 0.5, iki çekirdek için 2)",
