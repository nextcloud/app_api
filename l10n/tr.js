OC.L10N.register(
    ...
    "Failed to register ExApp" : "ExApp kaydedilemedi",
    "Failed to deploy ExApp" : "ExApp dağıtılamadı",
    "Failed to send \"init\" event to ExApp." : "ExApp için \"init\" etkinliği gönderilemedi",
    ...
    "Delete" : "Sil",
    "Confirm Deploy daemon deletion" : "Dağıtım arka plan işlemini silmeyi onaylayın",
    "Cancel" : "İptal",
    "Ok" : "Tamam",
    ...
    "Only NVIDIA GPUs are supported for now." : "Şu anda yalnızca NVIDIA GPU aygıtları destekleniyor.",
    "Register" : "Kaydet",
