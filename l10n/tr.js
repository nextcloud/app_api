OC.L10N.register(
    ...
    "This app is not installed from the AppStore. No extra information available. Only enable/disable and remove actions are allowed." : "Bu uygulama AppStore üzerinden kurulmamış. Başka bir bilgi bulunamadı. Yalnızca etkinleştirme, kullanımdan kaldırma ve uygulamayı kaldırma işlemleri yapılabilir.",
    "Could not perform installation of ExApp" : "ExApp kurulumu yapılamadı",
    "Failed to enable ExApp" : "ExApp etkinleştirilemedi",
    "Failed to disable ExApp" : "ExApp devre dışı bırakılamadı",
    ...
    "Check if ExApp successfully handled the enabled event and registered all stuff properly" : "Etkinleştirilmiş olayın ExApp tarafından işlenip işlenmediğini ve her şeyin düzgün kaydedilip edilmediğini sınar",
    ...
    "This app is not registered in AppStore. No extra information available. Only enable/disable and remove actions are allowed." : "Bu uygulama AppStore üzerinde kayıtlı değil. Başka bir bilgi bulunamadı. Yalnızca etkinleştirme, kullanımdan kaldırma ve uygulamayı kaldırma işlemleri yapılabilir.",
