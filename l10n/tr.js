OC.L10N.register(
    ...
    "Only docker-install is supported for now" : "Şu anda yalnızca docker-install destekleniyor",
    "Failed to register ExApp" : "Dış uygulama kaydedilemedi",
    "Failed to deploy ExApp" : "Dış uygulama dağıtılamadı",
    "Failed to send \"init\" event to ExApp." : "Dış uygulamaya \"init\" etkinliği gönderilemedi",
    "Failed to enable ExApp" : "Dış uygulama etkinleştirilemedi",
    "Failed to disable ExApp" : "Dış uygulama devre dışı bırakılamadı",
    "Could not update ExApp" : "Dış uygulama güncellenemedi",
    "AppAPI authentication failed" : "AppAPI kimliği doğrulanamadı ",
    "AppAPI ExApp version update notifier" : "AppAPI dış uygulama sürümü güncelleme bildirimi",
    "AppAPI ExApp notifier" : "AppAPI dış uygulama bildirimi",
    "AppAPI" : "AppAPI",
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below." : "Dış uygulamalar yönetimi, varsayılan uygulamalara benzer ve aşağıdaki bağlantıdan edinilebilir.",
    ...
    "Currently only Docker Daemon is supported." : "Şu anda yalnızda Docker arka plan işlemi destekleniyor.",
    ...
    "This app is not registered in AppStore. No extra information available. Only enable/disable actions allowed." : "Bu uygulama AppStore üzerinde kayıtlı değil. Başka bir bilgi bulunamadı. Yalnızca etkinleştirme ya da devre dışı bırakma işlemleri yapılabilir.",
    ...
    "External App URL: " : "Dış uygulama adresi: ",
    "System: " : "Sistem:",
    "Required" : "Zorunlu",
    "Optional" : "İsteğe bağlı",
    "All granted scopes" : "İzin verilen tüm kapsamlar",
    "No required scopes" : "Zorunlu bir kapsam yok",
    "No optional scopes" : "İsteğe bağlı bir kapsam yok",
    ...
    "This action will not remove installed ExApps on this daemon" : "Bu işlem, bu arka plan işlemine kurulmuş dış uygulamaları kaldırmaz",
    ...
    "Default daemon. ExApps will be installed on it" : "Varsayılan arka plan işlemi. Dış uygulamalar bunun üzerine kurulacak",
    ...
    "SSL params" : "SSL parametreleri",
    "SSL key:" : "SSL anahtarı:",
    "SSL key pass:" : "SSL anahtarı parolası:",
    "SSL cert:" : "SSL sertifikası:",
    "SSL cert pass:" : "SSL sertifikası parolası:",
    "GPUs support:" : "Grafik işlemci desteği:",
    ...
    "No DaemonConfigs" : "Herhangi bir DaemonConfig yok",
    "No DaemonConfigs registered. Create a custom one or setup default configuration automatically" : "Herhangi bir DaemonConfig kaydedilmemiş. Özel bir tane oluşturun ya da otomatik olarak varsayılan yapılandırmayı kurun",
    "Register default DaemonConfig" : "Varsayılan DaemonConfig ayarlarını kaydet",
    ...
    "Supported daemon accepts-deploy-id:" : "Desteklenen arka plan işlemi accepts-deploy-id:",
    "These are the default settings for a regular DaemonConfig. You can change them as you wish; more info on that is in the docs." : "Bunlar arka plan işlemi için normal DaemonConfig varsayılan ayarlarıdır. İstediğiniz gibi değiştirebilirsiniz. Ayrıntılı bilgi almak için belgeler bölümüne bakabilirsiniz.",
    "Unique Deploy Daemon Name" : "Benzersiz dağıtım arka plan işlemi adı",
    "Display name" : "Görüntülenecek ad",
    "Accepts deploy ID" : "Kabul edilen dağıtım kimliği",
    "Select daemon accepts-deploy-id" : "Arka plan işlemi accepts-deploy-id seçin",
    "Protocol" : "İletişim kuralı",
    "Select protocol" : "İletişim kuralını seçin",
    "Daemon host" : "Arka plan işlemi sunucusu",
    "Daemon host (e.g. /var/run/docker.sock, proxy-domain.com:2375)" : "Arka plan işlemi sunucusu (/var/run/docker.sock, proxy-domain.com:2375 gibi)",
    "Nextcloud URL" : "Nextcloud adresi",
    ...
    "Host" : "Sunucu",
    "Hostname to reach ExApp (optional)" : "ExApp erişimi yapılacak sunucu adı (isteğe bağlı)",
    "Enable gpus support (attach gpu to ExApp containers)" : "GPU desteği kullanılsın (ExApp kapsayıcılarına GPU ekleme)",
    "Enable GPUs support" : "GPU desteği kullanılsın",
    "All GPU devices will be requested to be enabled in ExApp containers" : "Tüm GPU aygıtlarının ExApp kapsayıcılarında etkinleştirilmesi istenecek",
    "Register" : "Hesap aç",
    "Unix socket path (e.g. /var/run/docker.sock)" : "Unix soketinin yolu (örnek: /var/run/docker.sock)",
    "Host with port (e.g. proxy-domain.com:2375)" : "Sunucu ve bağlantı noktası (örnek: proxy-domain.com:2375)",
