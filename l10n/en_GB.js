OC.L10N.register(
    ...
    "Maximum memory that the ExApp container can use in mebibytes" : "Maximum memory that the ExApp container can use in mebibytes",
    "Must be a positive integer" : "Must be a positive integer",
    "Maximum CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)" : "Maximum CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)",
