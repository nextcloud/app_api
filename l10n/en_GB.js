OC.L10N.register(
    ...
    "Only docker-install is supported for now" : "Only docker-install is supported for now",
    "Failed to register ExApp" : "Failed to register ExApp",
    "Failed to deploy ExApp" : "Failed to deploy ExApp",
    "Failed to send \"init\" event to ExApp." : "Failed to send \"init\" event to ExApp.",
    ...
    "AppAPIAuth authentication failed" : "AppAPIAuth authentication failed",
    ...
    "ExApps" : "ExApps",
    "ExApps management similar to default apps and available by the link below." : "ExApps management similar to default apps and available by the link below.",
    ...
    "Currently only Docker Daemon is supported." : "Currently only Docker Daemon is supported.",
    ...
    "This app is not registered in AppStore. No extra information available. Only enable/disable actions allowed." : "This app is not registered in AppStore. No extra information available. Only enable/disable actions allowed.",
    ...
    "External App URL: " : "External App URL: ",
    "System: " : "System: ",
    "Required" : "Required",
    "Optional" : "Optional",
    "All granted scopes" : "All granted scopes",
    "No required scopes" : "No required scopes",
    "No optional scopes" : "No optional scopes",
    ...
    "This action will not remove installed ExApps on this daemon" : "This action will not remove installed ExApps on this daemon",
    ...
    "SSL params" : "SSL params",
    "SSL key:" : "SSL key:",
    "SSL key pass:" : "SSL key pass:",
    "SSL cert:" : "SSL cert:",
    "SSL cert pass:" : "SSL cert pass:",
    "GPUs support:" : "GPUs support:",
    ...
    "No DaemonConfigs" : "No DaemonConfigs",
    "No DaemonConfigs registered. Create a custom one or setup default configuration automatically" : "No DaemonConfigs registered. Create a custom one or setup default configuration automatically",
    "Register default DaemonConfig" : "Register default DaemonConfig",
    ...
    "This is default settings for regular DaemonConfig. You can change it as you wish, more info on that in docs." : "This is default settings for regular DaemonConfig. You can change it as you wish, more info on that in docs.",
    "Unique Deploy Daemon Name" : "Unique Deploy Daemon Name",
    "Display name" : "Display name",
    "Accepts deploy ID" : "Accepts deploy ID",
    "Select daemon accepts-deploy-id" : "Select daemon accepts-deploy-id",
    "Protocol" : "Protocol",
    "Select protocol" : "Select protocol",
    "Daemon host" : "Daemon host",
    "Daemon host (e.g. /var/run/docker.sock, proxy-domain.com:2375)" : "Daemon host (e.g. /var/run/docker.sock, proxy-domain.com:2375)",
    "Nextcloud URL" : "Nextcloud URL",
    ...
    "Host" : "Host",
    "Hostname to reach ExApp (optional)" : "Hostname to reach ExApp (optional)",
    ...
    "All GPU devices will be requested to be enabled in ExApp containers" : "All GPU devices will be requested to be enabled in ExApp containers",
    "Register" : "Register",
    "Unix socket path (e.g. /var/run/docker.sock)" : "Unix socket path (e.g. /var/run/docker.sock)",
    "Host with port (e.g. proxy-domain.com:2375)" : "Host with port (e.g. proxy-domain.com:2375)",
    "Your apps" : "Your apps",
