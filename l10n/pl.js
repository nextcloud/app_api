OC.L10N.register(
    ...
    "Maximum memory that the ExApp container can use in mebibytes" : "Maksymalna pamięć, jaką kontener ExApp może używać w mebibajtach",
    "Must be a positive integer" : "Musi być liczbą całkowitą dodatnią",
    "Maximum CPU cores that the ExApp container can use (e.g. 0.5 for half a core, 2 for two cores)" : "Maksymalna liczba rdzeni CPU, jaką kontener ExApp może używać (np. 0.5 dla połowy rdzenia, 2 dla dwóch rdzeni)",
