OC.L10N.register(
    ...
    "This app is not registered in AppStore. No extra information available. Only enable/disable and remove actions are allowed." : "Esta aplicación non está rexistrada na tenda de aplicacións. Non hai información adicional dispoñíbel. Só se permiten as accións de activar/desactivar e eliminar.",
    ...
    "No apps found" : "Non se atoparon aplicacións",
    ...
    "No scopes granted to this app" : "Non se concedeu ningún ámbito a esta aplicación",
    ...
    "Failed to save admin options. Check the logs" : "Produciuse un fallo ao gardar as opcións de administración. Comprobe os rexistros",
    ...
    "Remove test ExApp" : "Eliminar a proba da aplicación externa (ExApp)",
    ...
    "Failed to register DaemonConfig. Check the logs" : "Produciuse un fallo ao rexistrar DaemonConfig. Comprobe os rexistros",
    "DaemonConfig successfully updated" : "DaemonConfig foi actualizado satisfactoriamente",
    "Failed to update DaemonConfig. Check the logs" : "Produciuse un fallo ao actualizar DaemonConfig. Comprobe os rexistros",
    ...
    "Action request sent to ExApp" : "Solicitude de acción enviada á aplicación externa (ExApp)",
    "Error while sending File action request to ExApp" : "Produciuse un erro ao enviar a solicitude de acción de ficheiro á aplicación externa (ExApp)",
