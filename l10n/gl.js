OC.L10N.register(
    ...
    "Deploy Daemons. Deploy Daemon (DaemonConfig) is an ExApps orchestration daemon." : "Despregue de servizos. O servizo de despregue (DaemonConfig) é un servizo de orquestración de aplicacións externas (ExApps).",
    ...
    "AppAPI will try to install small skeleton ExApp to verify Daemon configured correctly and deployment steps are passing." : "AppAPI tentará instalar un pequeno esqueleto de aplicación externa (ExApp) para verificar que o servizo está configurado correctamente e que se están a cumprir os pasos de despregue.",
    "Enabled" : "Activado",
    "Display name" : "Nome para amosar",
